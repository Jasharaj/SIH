...
export const Support = () => {
  return (
    <div className="flex items-center justify-center bg-gray-950 px-8 py-24 text-white">
      <BlockInTextCard
        tag="/ Support"
        text={
          <>
...
const BlockInTextCard = ({ tag, text, examples }) => {
  return (
    <div className="w-full max-w-xl space-y-6">
      ...
      <button className="w-full rounded-full border border-white py-2 text-sm font-medium transition-colors hover:bg-white hover:text-black">
        Contact Support
      </button>
    </div>
  );
